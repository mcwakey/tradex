...
<div class="col-md-12">
	<div class="form-group">
		{!! Form::label('shipping_status_modal', __('Statut Embalage') . ':' ) !!}
		{!! Form::select('shipping_status_modal',$shipping_statuses, !empty($transaction->shipping_status) ? $transaction->shipping_status : null, ['class' => 'form-control','placeholder' => __('messages.please_select')]); !!}
					...
					<div class="col-md-4">
				        <div class="form-group">
				            {!! Form::label('shipping_details_modal', __('BTLE') . ':*' ) !!}
				            {!! Form::text('shipping_details_modal', !empty($transaction->shipping_details) ? $transaction->shipping_details : '', ['class' => 'form-control','placeholder' => __('SNB C24')]); !!}
				        </div>
				    </div>
					...
					<!-- <div class="col-md-12">
				        <div class="form-group">
				            {!! Form::label('shipping_details_modal', __('BTLE') . ':*' ) !!}
				            {!! Form::text('shipping_details_modal2', !empty($transaction->shipping_details) ? $transaction->shipping_details : '', ['class' => 'form-control','placeholder' => __('BTLE')]); !!}
				        </div>
				    </div> -->
					...
					@if(!empty($shipping_custom_label_1))
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								{!! Form::text('shipping_custom_field_11', !empty($transaction->shipping_custom_field_1) ? $transaction->shipping_custom_field_1 : null, ['class' => 'form-control','placeholder' => 'BB P20', 'required' => $is_shipping_custom_field_1_required]); !!}
							</div>
						</div>
					@endif
					@if(!empty($shipping_custom_label_2))
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								{!! Form::text('shipping_custom_field_21', !empty($transaction->shipping_custom_field_2) ? $transaction->shipping_custom_field_2 : null, ['class' => 'form-control','placeholder' => 'BB P20', 'required' => $is_shipping_custom_field_2_required]); !!}
							</div>
						</div>
					@endif
					@if(!empty($shipping_custom_label_3))
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								{!! Form::text('shipping_custom_field_31', !empty($transaction->shipping_custom_field_3) ? $transaction->shipping_custom_field_3 : null, ['class' => 'form-control','placeholder' => 'BB P24', 'required' => $is_shipping_custom_field_3_required]); !!}
							</div>
						</div>
					@endif
					@if(!empty($shipping_custom_label_4))
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								{!! Form::text('shipping_custom_field_41', !empty($transaction->shipping_custom_field_4) ? $transaction->shipping_custom_field_4 : null, ['class' => 'form-control','placeholder' => 'SNB P12', 'required' => $is_shipping_custom_field_4_required]); !!}
							</div>
						</div>
					@endif
					@if(!empty($shipping_custom_label_5))
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								{!! Form::text('shipping_custom_field_51', !empty($transaction->shipping_custom_field_5) ? $transaction->shipping_custom_field_5 : null, ['class' => 'form-control','placeholder' => 'SNB P20', 'required' => $is_shipping_custom_field_5_required]); !!}
							</div>
						</div>
					@endif
					...
					<!-- <div class="col-md-4">
						<div class="form-group">
							{!! Form::label('shipping_details_modal', __('SNB P24') . ':*' ) !!}
							{!! Form::text('shipping_details_modal1', !empty($transaction->shipping_details) ? $transaction->shipping_details : '', ['class' => 'form-control','placeholder' => __('SNB P24')]); !!}
						</div>
					</div> -->
			</div>
