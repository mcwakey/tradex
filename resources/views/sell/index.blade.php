                ...
                <table class="table table-bordered table-striped ajax_view" id="sell_table">
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 footer-total text-center">
                            ...
                            <td></td>
                            <td class="footer_casier_total"></td>
                            <td class="footer_bouteille_total"></td>
                            <td class="footer_plastic_total"></td>
        ...
        $(document).ready(function() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                columns: [{
                    ...
                    // {
                    //     data: 'shipping_custom_field_6',
                    //     name: 'shipping_custom_field_6'
                    // },
                    // {
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    var footer_casier_total = 0;
                    var footer_bouteille_total = 0;
                    var footer_plastic_total = 0;

                    for (var r in data) {
                        footer_casier_total += $(data[r].staff_note).data('orig-value') ? 
                            $(data[r].staff_note).data('orig-value') : 0;
                        footer_bouteille_total += $(data[r].shipping_custom_field_2).data('orig-value') ? parseFloat($(
                            data[r].final_total).data('orig-value')) : 0;
                        footer_plastic_total += $(data[r].shipping_custom_field_3).data('orig-value') ? parseFloat($(
                            data[r].final_total).data('orig-value')) : 0;
                    ...
                    $('.footer_casier_total').html(footer_casier_total);
                    $('.footer_bouteille_total').html(footer_bouteille_total);
                    $('.footer_plastic_total').html(footer_plastic_total);
