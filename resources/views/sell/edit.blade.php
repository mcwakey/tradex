...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			<div class="col-md-12">
				<div class="form-group">
		            {!! Form::label('shipping_status', __('Statut Embalage')) !!}
	        ...
	        @endphp
				...
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('shipping_address', __('SNB C24')) !!}
						{!! Form::text('shipping_address', $transaction->shipping_address, ['class' => 'form-control','placeholder' => __('SNB C24')]); !!}
					</div>
				</div>
...
<hr/>
				...
				<div class="col-md-12">
					<div class="form-group">
						{!! Form::label('shipping_address', __('BTLE')) !!}
						{!! Form::text('shipping_address', $transaction->shipping_address, ['class' => 'form-control','placeholder' => __('SNB C24')]); !!}
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('shipping_custom_field_5', 'SNB P20' ) !!}
						{!! Form::text('shipping_custom_field_5', !empty($transaction->shipping_custom_field_5) ? $transaction->shipping_custom_field_5 : null, ['class' => 'form-control','placeholder' => $shipping_custom_label_5, 'required' => $is_shipping_custom_field_5_required]); !!}
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('shipping_address', __('SNB P24')) !!}
						{!! Form::text('shipping_address', $transaction->shipping_address, ['class' => 'form-control','placeholder' => __('SNB C24')]); !!}
					</div>
				</div>
			@endcomponent
