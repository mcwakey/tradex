...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			@component('components.widget', ['class' => 'box-solid', 'title' => __('Embalage')])
			...
			<div class="col-md-4">
				<div class="form-group">
		            {!! Form::label('shipping_details', __('BTLE')) !!}
		            {!! Form::text('shipping_details',null, ['class' => 'form-control','placeholder' => __('SNB P24')]); !!}
		        </div>
			</div>
			...
			<!-- <div class="col-md-12">
				<div class="form-group">
		            {!! Form::label('shipping_details', __('BTLE')) !!}
		            {!! Form::text('shipping_details',null, ['class' => 'form-control','placeholder' => __('BTLE')]); !!}
		        </div>
			</div> -->
			...
			@if(!empty($shipping_custom_label_1))
				...
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('shipping_custom_field_1', 'BB P12' ) !!}
						{!! Form::text('shipping_custom_field_11', !empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_1']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_1'] : null, ['class' => 'form-control','placeholder' => 'BB P12', 'required' => $is_shipping_custom_field_1_required]); !!}
					</div>
				</div>
			@endif
			@if(!empty($shipping_custom_label_2))
				...
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('shipping_custom_field_2', 'BB P20' ) !!}
						{!! Form::text('shipping_custom_field_21', !empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_2']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_2'] : null, ['class' => 'form-control','placeholder' => 'BB P20', 'required' => $is_shipping_custom_field_2_required]); !!}
					</div>
				</div>
			@endif
			@if(!empty($shipping_custom_label_3))
				...
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('shipping_custom_field_3', 'BB P24' ) !!}
						{!! Form::text('shipping_custom_field_31', !empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_3']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_3'] : null, ['class' => 'form-control','placeholder' => 'BB P24', 'required' => $is_shipping_custom_field_3_required]); !!}
					</div>
				</div>
			@endif
			@if(!empty($shipping_custom_label_4))
				...
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('shipping_custom_field_4', 'SNB P12' ) !!}
						{!! Form::text('shipping_custom_field_41', !empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_4']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_4'] : null, ['class' => 'form-control','placeholder' => $shipping_custom_label_4, 'required' => $is_shipping_custom_field_4_required]); !!}
					</div>
				</div>
			@endif
			@if(!empty($shipping_custom_label_5))
				...
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('shipping_custom_field_5', 'SNB P24' ) !!}
						{!! Form::text('shipping_custom_field_51', !empty($walk_in_customer['shipping_custom_field_details']['shipping_custom_field_5']) ? $walk_in_customer['shipping_custom_field_details']['shipping_custom_field_5'] : null, ['class' => 'form-control','placeholder' => $shipping_custom_label_5, 'required' => $is_shipping_custom_field_5_required]); !!}
					</div>
				</div>
			@endif
			<!-- <div class="col-md-4">
				<div class="form-group">
		            {!! Form::label('shipping_details', __('SNB P24')) !!}
		            {!! Form::text('shipping_details',null, ['class' => 'form-control','placeholder' => __('SNB P24')]); !!}
		        </div>
			</div> -->
